...
if isfield(img_summary, 'results_hb')
    ...
    fig_handle_temp = PlotIndivFScoreCurve(img_summary.results_hb, thval, COLOR_HB, LINE_WIDTH, LINE_STYLE, fig_handle);
else
    fig_handle_temp = [];
end
...
if isfield(img_summary, 'results_bf')
    ...
    fig_handle_temp = PlotIndivFScoreCurve(img_summary.results_bf, thval, COLOR_BF, LINE_WIDTH, LINE_STYLE, fig_handle);
else
    fig_handle_temp = [];
end
...
if isfield(img_summary, 'results_rs')
    fig_handle_temp = PlotIndivFScoreCurve(img_summary.results_rs, 0, COLOR_RS, LINE_WIDTH, LINE_STYLE, fig_handle);
else
    fig_handle_temp = [];
end
...
if isfield(img_summary, 'results_db')
    fig_handle_temp = PlotIndivFScoreCurve(img_summary.results_db, 0, COLOR_DB, LINE_WIDTH, LINE_STYLE, fig_handle);
else
    fig_handle_temp = [];
end
