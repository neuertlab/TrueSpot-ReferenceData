...
outstem = [DataDir filesep 'data' filesep 'deepblink' getRSDBGroupOutputDir(ImgName) ImgName filesep 'DeepBlink_' ImgName];
...
if NewAnno | ~RNA_Threshold_SpotSelector.selectorExists(outstem)
    ...
    RefCompare_DeepBlink(refstem, outstem, false);
